...
CREATE OR REPLACE FUNCTION "battleship"."request_bombing"("v_user_id" int4, "v_topic" int4)
...
BEGIN
    ...
    -- save speech topic
    UPDATE games set speech_topic = v_topic where game_id = v_game_id;
    -- return opponent_id
...
DROP FUNCTION "battleship"."request_bombing";